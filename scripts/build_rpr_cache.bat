...
"C:\\Program Files\\Blender Foundation\\Blender %TOOL_VERSION%\\blender.exe" -b "C:\TestResources\rpr_blender_autotests_assets\Materials\Test_Scene.blend" -E RPR -P "cache_build.py"